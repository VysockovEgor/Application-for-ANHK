import 'package:anhk/pages/report/get_report_page.dart';
import 'package:anhk/pages/report/create_report_page.dart';
...
class Report extends StatelessWidget {
  ...
  void _navigate(BuildContext context, bool search) {
    Navigator.pushReplacement(
      context,
      MaterialPageRoute(
        builder: (_) => search ? const GetReport() : const CreateReport(),
      ),
    );
  }
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        ElevatedButton(
                          ...
                          child: const Text('Получить отчёт'),
                        ),
