...
class MyHomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    int crossAxisCount = (screenWidth / 140).floor(); // Разделим ширину экрана на размер квадратика
    ...
    // Устанавливаем количество столбцов — всегда 2
    int rowCount = 6;
      ...
      children: [
        ...
        const Text(
          ...
          style: TextStyle(
            ...
            overflow: TextOverflow.ellipsis, // Если текст не помещается, он будет сокращаться
          ),
        ),
      ],
    );
